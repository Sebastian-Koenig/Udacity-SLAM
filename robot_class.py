...
class robot:
    ...
    def sense(self):
        ...
        measurements = []
        # itterate through the number of landmarks and calculate the measurement with noise
        for i in range(self.num_landmarks):
            ...
            #append the measurement, including the landmarks index, if dx and dy are within measurement range
